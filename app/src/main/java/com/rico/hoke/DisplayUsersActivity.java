...
public class DisplayUsersActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shared = getSharedPreferences("RICO",
        ...
        public View getView(final int position, View
            ...
            btnDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(DisplayUsersActivity.this, "User Successfully Deleted", Toast.LENGTH_SHORT).show();fetch_users(); }
            });
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(DisplayUsersActivity.this, "You've been Successfully Logout", Toast.LENGTH_SHORT).show();
